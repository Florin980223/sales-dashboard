...
This is a learning/practice project: a Vite + React Sales Team Dashboard backed by Supabase.
...
- forms for adding deals
- deployed demo on Vercel
- GitHub workflow practice

The main goal is to make this project clean, modern, stable, and easy to explain in a portfolio/interview.
